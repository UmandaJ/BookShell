...
const Settings = () => {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      try {
        // Profile
        const uRes = await axios.get("http://localhost:1000/api/v1/get-user-information", { headers });
        ...
        const ordersRes =
          role === "seller"
            ? await axios.get("http://localhost:1000/api/v1/get-all-orders", { headers })
            : await axios.get("http://localhost:1000/api/v1/get-order-history", { headers });
        ...
        // Favourites
        const favRes = await axios.get("http://localhost:1000/api/v1/get-favourite-books", { headers });
